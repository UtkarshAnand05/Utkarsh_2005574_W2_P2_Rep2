...
open_system('Utkarsh_2005574_W2_P2'); % code does not appear in the example HTML
evalc('sim(''Utkarsh_2005574_W2_P2'')'); %simulate and don't display output
...
open_system('Utkarsh_2005574_W2_P2/unlocked');
...
open_system('Utkarsh_2005574_W2_P2/locked');
...
open_system('Utkarsh_2005574_W2_P2/frictionModeLogic');
...
plot(Utkarsh_2005574_W2_P2_output.get('Tin').Values.Time, ...
     Utkarsh_2005574_W2_P2_output.get('Tin').Values.Data, 'b', ...
     Utkarsh_2005574_W2_P2_output.get('Fn').Values.Time,  ...
     Utkarsh_2005574_W2_P2_output.get('Fn').Values.Data,  'r'  );
xlabel('Time (sec)');
...
plot(Utkarsh_2005574_W2_P2_output.get('EngineSpeed').Values.Time, ...
     Utkarsh_2005574_W2_P2_output.get('EngineSpeed').Values.Data,  'r', ...
     Utkarsh_2005574_W2_P2_output.get('VehicleSpeed').Values.Time, ...
     Utkarsh_2005574_W2_P2_output.get('VehicleSpeed').Values.Data, 'b', ...
     Utkarsh_2005574_W2_P2_output.get('ShaftSpeed').Values.Time, ...
     Utkarsh_2005574_W2_P2_output.get('ShaftSpeed').Values.Data,   'g'  );
xlabel('Time (sec)');
...
close_system('Utkarsh_2005574_W2_P2_output',0);
clear Utkarsh_2005574_W2_P2_output;
