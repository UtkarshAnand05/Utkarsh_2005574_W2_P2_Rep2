function Utkarsh_2005574_W2_P2plot(Action)
...
Vars=evalin('base','whos(''Utkarsh_2005574_W2_P2_output'')');
...
if ~isempty(Vars) && ~isempty(Value),  
  ...
  for lp=1:10,          
      ...
      y_data=evalin('base',['Utkarsh_2005574_W2_P2_output.get(''', PlotMe ''')', '.Values.Data']);        
      x_data=evalin('base',['Utkarsh_2005574_W2_P2_output.get(''', PlotMe ''')', '.Values.Time']);        
...
Name=find_system('Utkarsh_2005574_W2_P2','SearchDepth',1,'BlockType','Outport');
...
TempInputName=find_system('Utkarsh_2005574_W2_P2'     , ...
                          'SearchDepth',1, ...
...
ModelPos=get_param('Utkarsh_2005574_W2_P2','Location');

FigX=0;FigY=0;
%%% Create Everything %%%    
Fig=figure('Units'          ,'points'                                , ...
           'Position'       ,[FigX FigY FigWidth FigHeight]          , ...
           'CloseRequestFcn','Utkarsh_2005574_W2_P2plot Close'                      , ...
           'Menubar'        ,'none'                                  , ...
           'Colormap'       ,[]                                      , ...
           'NumberTitle'    ,'off'                                   , ...
